...
for(i in 1:length(time_interval)){
  ...
  ggsave(
    plot = plot,
    filename =  paste0("/media/romuald/TOSHIBA EXT/Romuald_NGS/MARS-ATAC/exp/ATAC_differential_accessibility/2021_01_01/plot_volcano_promoter_intergenic_", time_interval[i],".png"))
